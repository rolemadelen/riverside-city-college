 ...
 *
 * File name: GameOneCompFrame.java
 * Coded by : Jiwon Yoo
 */
 ...
 * @author Jiwon
 */
public class GameOneCompFrame extends javax.swing.JFrame {
    ...
    private int[] player_points = {0, 0};
    
    // count each player's wrong answer
    private int[] player_wrong = {0, 0};
    
    // count number of turns
    private int[] player_turns = {0, 0};
    
    /**
     * Creates new form GameScreenFrame
     */
    public GameOneCompFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        playerAnswerTextField.setBounds(120, 350, 160, 30);
        ...
        convertThisLabel.setBounds(260, 40, 140, 15);
        ...
        p1PointsLabel.setBounds(145, 550, 110, 30);
        ...
        p2PointsLabel.setBounds(540, 550, 110, 30);
        ...
        correctWrongP1.setBounds(90, 210, 220, 180);
        ...
        correctWrongP2.setBounds(490, 210, 220, 180);
        ...
        panel.add(p1Label);
        p1Label.setBounds(130, 670, 120, 15);
        ...
        panel.add(p2Label);
        p2Label.setBounds(550, 670, 120, 15);
        ...
        panel.add(quitIntro);
        quitIntro.setBounds(460, 160, 150, 15);
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
         ...
         // if input is not empty
            ...
            correctWrongP2.setText(" ");
             // if p1's turn and answer is right, it is p2's turn
             switch(turn) {
                 case 1:
                     player_turns[0] += 1;
                   ...
                   //Thread.resetTimer();
                    ...
                    playerAnswerTextField.setBounds(525, 350, 160, 30);
                    turn = 2;
                    break;
                 case 2:
                     player_turns[1] += 1;
