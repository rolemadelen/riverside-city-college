 ...
 *
 * File name: GameThreeCompFrame.java
 * Coded by : Jiwon Yoo
 */
 ...
 * @author Jiwon
 */
public class GameThreeCompFrame extends javax.swing.JFrame {
    private static GameModeFrame gmFrame = new GameModeFrame();
    private int turn = 1; /* 1 = player1, 2 = player2,
                             3 = player3, 4 = player4*/
    private boolean game_on = true;
    // record each player's points
    private int[] player_points = {0, 0, 0, 0};
    
    /**
     * Creates new form GameScreenFrame
     */
    public GameThreeCompFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        playerAnswerTextField.setBounds(40, 360, 120, 30);
        ...
        p1PointsLabel.setBounds(40, 550, 110, 30);
        ...
        p2PointsLabel.setBounds(240, 550, 110, 30);
        ...
        p3PointsLabel.setBounds(440, 550, 110, 30);

        p4PointsLabel.setBackground(java.awt.Color.black);
        p4PointsLabel.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        p4PointsLabel.setForeground(java.awt.Color.red);
        p4PointsLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        p4PointsLabel.setText("0");
        panel.add(p4PointsLabel);
        p4PointsLabel.setBounds(640, 550, 110, 30);

        correctWrongP1.setBackground(java.awt.Color.black);
        correctWrongP1.setFont(new java.awt.Font("Tahoma", 0, 28)); // NOI18N
        ...
        correctWrongP3.setBounds(390, 210, 220, 180);

        correctWrongP4.setBackground(java.awt.Color.black);
        correctWrongP4.setFont(new java.awt.Font("Tahoma", 0, 28)); // NOI18N
        correctWrongP4.setForeground(java.awt.Color.green);
        correctWrongP4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        correctWrongP4.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        panel.add(correctWrongP4);
        correctWrongP4.setBounds(590, 210, 220, 180);
        ...
        p1Character.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/game/player.png"))); // NOI18N
        p1Character.setToolTipText("");
        p1Character.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        ...
        p2Character.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/game/player.png"))); // NOI18N
        p2Character.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        p2Character.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.white));
        gridPanel.add(p2Character);

        p3Character.setBackground(java.awt.Color.black);
        p3Character.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        p3Character.setForeground(java.awt.Color.red);
        p3Character.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        p3Character.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/game/player.png"))); // NOI18N
        p3Character.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        p3Character.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.white));
        gridPanel.add(p3Character);

        p4Character.setBackground(java.awt.Color.black);
        p4Character.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        p4Character.setForeground(java.awt.Color.red);
        p4Character.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        p4Character.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/game/player.png"))); // NOI18N
        p4Character.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        p4Character.setBorder(javax.swing.BorderFactory.createLineBorder(java.awt.Color.white));
        gridPanel.add(p4Character);
        ...
        panel.add(p1Label);
        p1Label.setBounds(40, 670, 120, 14);
        ...
        panel.add(p2Label);
        p2Label.setBounds(240, 670, 120, 14);
        ...
        panel.add(p3Label);
        p3Label.setBounds(440, 670, 120, 14);

        p4Label.setBackground(java.awt.Color.black);
        p4Label.setForeground(java.awt.Color.white);
        p4Label.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        p4Label.setText("Player 4");
        panel.add(p4Label);
        p4Label.setBounds(640, 670, 120, 14);
         ...
         // if input is not empty
             ...
             switch(turn) {
                case 1: 
                    ...
                    playerAnswerTextField.setBounds(240, 360, 120, 30);
                    turn = 2;
                    break;
                case 2:
                  ...
                  playerAnswerTextField.setBounds(440, 360, 120, 30);
                  turn = 3;
                    break;
                case 3:
                  ...
                  playerAnswerTextField.setBounds(640, 360, 120, 30);
                  turn = 4;
                    break;
                case 4:
                    //if p4 answer is right, get points
                    if(gmFrame.checkAnswer(playerAnswerTextField.getText())) {
                        player_points[3] += 15;
                        correctWrongP4.setText("CORRECT !!");
                        correctWrongP4.setForeground(Color.blue);
                        correctWrongP1.setText("");
                        Option.soundEffect("src/sound/correct.wav");
                    } else { 
                        player_points[3] -= 10;
                        correctWrongP4.setText("WRONG !!");
                        correctWrongP4.setForeground(Color.red);
                        correctWrongP1.setText("");
                        Option.soundEffect("src/sound/wrong.wav");
                        gmFrame.wrong();
                    }
                  p4PointsLabel.setText(Integer.toString(player_points[3]));
                  playerAnswerTextField.setBounds(40, 360, 120, 30);
                  turn = 1; 
                    break;
            }
...
//        if(turn == 1) {
//            player_points[3] -= 5;
//            correctWrongP4.setText("TIME'S UP !!");
//            correctWrongP4.setForeground(Color.red);
//            p4PointsLabel.setText(Integer.toString(player_points[3]));
//            playerAnswerTextField.setBounds(40, 360, 120, 30);
//            correctWrongP1.setText("");
...
//    }
    ...
    private javax.swing.JLabel correctWrongP4;
    ...
    private javax.swing.JLabel p3Character;
    private javax.swing.JLabel p3Label;
    private javax.swing.JLabel p3PointsLabel;
    private javax.swing.JLabel p4Character;
    private javax.swing.JLabel p4Label;
    private javax.swing.JLabel p4PointsLabel;
