...
// POST_CONDITION :	two random digit is flipped
//////////////////////////////////////////////////////////////////////
void flipDig( char *cp, const int begin, const int SIZE ) {
	int pos1 = (rand()%SIZE-begin)+begin;
	int pos2 = pos1;
	while(pos2==pos1) 
		pos2 = (rand()%SIZE-begin)+begin;
	int val1 = ((pos1+1)%2==0)?(cp[pos1]-48)*2:cp[pos1]-48;
	int val2 = ((pos2+1)%2==0)?(cp[pos2]-48)*2:cp[pos2]-48;
	cp[pos1] = (val1<10)?val1+48:val1+39;
	cp[pos2] = (val2<10)?val2+48:val2+39;
	return;
}
