...
* Student ID : 2485776
* Professor Ung
* Homewwork 11 - problem 9
* I certify this is my own work and code!
*/

// Using number 7 and 8, use constructors instead of
// the get/set member functions to create instances of your class.
// Output the instances of both the default constructor
// and the one that takes three parameters.
